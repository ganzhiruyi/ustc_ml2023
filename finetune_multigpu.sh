#!/usr/bin/env bash
#SBATCH --job-name=ml2023_multigpu # create a short name for your job
...
MODEL_NAME=erlangshen1.3B_multigpu
...
OUTPUT_PATH="./output_multigpu"
PREDICT_FILE="${OUTPUT_PATH}/${MODEL_NAME}.csv"

export WANDB_PROJECT='erlangshen1.3B'
export WANDB_LOG_MODEL='all'
export run_name='ml2023_multigpu'
